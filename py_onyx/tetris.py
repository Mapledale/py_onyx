...
# BOARD_COL = 15  # number of colums in the canvas
# BOARD_ROW = 20  # number of rows in the canvas
# BOARD_HEIGHT = BOARD_ROW * CELL_SIZE
# BOARD_WIDTH = BOARD_COL * CELL_SIZE
